...
aj_check :: IO ()
aj_check = forM_ [(-2147483648,-1073741782), (-2147483647,1337), (-1,1337), (0,42), (1,1337), (2147483646,1337), (2147483647,1073741865)] $ \(I# i,o) -> do
   let r = I# (aj i)
   unless (r == o) $ putStrLn $ "ERR: aj (" ++ show (I# i)++ ") is " ++ show r ++ " and not " ++ show o ++"."

ak_check :: IO ()
ak_check = forM_ [(2147483636,1337), (2147483637, 1073741860), (2147483638, 1073741861), (2147483639, 1073741861), (2147483640, 1073741862), (2147483641, 1073741862), (2147483642, 1073741863), (2147483643, 1073741863), (2147483644, 1073741864), (2147483645, 1073741864), (2147483646, 1073741865), (2147483647, 1073741865)] $ \(I# i,o) -> do
   let r = I# (ak i)
   unless (r == o) $ putStrLn $ "ERR: ak (" ++ show (I# i)++ ") is " ++ show r ++ " and not " ++ show o ++"."

al_check :: IO ()
al_check = forM_ [(-2147483648,-1073741782), (-2147483647,-1073741782), (-2147483646,-1073741781), (-2147483645,-1073741781), (-2147483644,-1073741780), (-2147483643,-1073741780), (-2147483642,-1073741779), (-2147483641,-1073741779), (-2147483640,-1073741778), (-2147483639,-1073741778), (-2147483638,-1073741777), (-2147483637,1337), (2147483636,1337), (2147483637, 1073741860), (2147483638, 1073741861), (2147483639, 1073741861), (2147483640, 1073741862), (2147483641, 1073741862), (2147483642, 1073741863), (2147483643, 1073741863), (2147483644, 1073741864), (2147483645, 1073741864), (2147483646, 1073741865), (2147483647, 1073741865), (2147483636,1337), (2147483637, 1073741860), (2147483638, 1073741861), (2147483639, 1073741861), (2147483640, 1073741862), (2147483641, 1073741862), (2147483642, 1073741863), (2147483643, 1073741863), (2147483644, 1073741864), (2147483645, 1073741864), (2147483646, 1073741865), (2147483647, 1073741865)] $ \(I# i,o) -> do
   let r = I# (al i)
...
ay_check :: IO ()
ay_check = forM_ [(0,42), (1,1337), (4294967294,1337), (4294967295,2147483689)] $ \(W# i,o) -> do
   let r = W# (ay i)
   unless (r == o) $ putStrLn $ "ERR: ay (" ++ show (W# i)++ ") is " ++ show r ++ " and not " ++ show o ++"."

az_check :: IO ()
az_check = forM_ [(4294967284,1337), (4294967285,2147483684), (4294967286,2147483685), (4294967287,2147483685), (4294967288,2147483686), (4294967289,2147483686), (4294967290,2147483687), (4294967291,2147483687), (4294967292,2147483688), (4294967293,2147483688), (4294967294,2147483689), (4294967295,2147483689)] $ \(W# i,o) -> do
   let r = W# (az i)
   unless (r == o) $ putStrLn $ "ERR: az (" ++ show (W# i)++ ") is " ++ show r ++ " and not " ++ show o ++"."

ba_check :: IO ()
ba_check = forM_ [(0,42), (1,42), (2,43), (3,43), (4,44), (5,44), (6,45), (7,45), (8,46), (9,46), (10,47), (11,1337), (4294967284,1337), (4294967285,2147483684), (4294967286,2147483685), (4294967287,2147483685), (4294967288,2147483686), (4294967289,2147483686), (4294967290,2147483687), (4294967291,2147483687), (4294967292,2147483688), (4294967293,2147483688), (4294967294,2147483689), (4294967295,2147483689)] $ \(W# i,o) -> do
   let r = W# (ba i)
